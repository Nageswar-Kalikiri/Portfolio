...
export default function Home() {
  ...
  const quickLinks = [
    ...
    { img: linkedinLogo, title: 'LinkedIn', link: 'https://www.linkedin.com/in/nageswar-kalikiri-a82693278/' },
    { img: gmailLogo, title: 'Email', link: 'mailto:kalikiri.nageswar03@gmail.com' },
    { img: whatsappLogo, title: 'WhatsApp', link: 'https://wa.me/7995785240' }, // ✅ Replace with your number
  ]
        ...
        >
          ...
          >
            {[
              ...
              { label: '💼 Fresher', value: 'Frontend (JavaScript, React), Backend (Node, Express), Database (MongoDB)' },
              { label: '📧 Contact', value: 'kalikiri.nageswar03@gmail.com' },
            ].map((info, i) => (
              <motion.div
                key={i}
